...
var TodoList = (function () {
    ...
    TodoList.prototype.deleteMemo = function (year, month, date) {
...
var SearchResults = (function () {
    function SearchResults() {
        this.resultsList = new Subject_1.Subject();
        this.resultsList$ = this.resultsList.asObservable();
    }
    SearchResults.prototype.setResultList = function (list) {
...
var forms_1 = __webpack_require__(512);
var app_component_1 = __webpack_require__(963);
var search_1 = __webpack_require__(967);
var calendar_1 = __webpack_require__(964);
var input_1 = __webpack_require__(965);
var results_1 = __webpack_require__(966);
var todolist_1 = __webpack_require__(968);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_operator_toPromise__ = __webpack_require__(417);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_forms__ = __webpack_require__(516);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__directives__ = __webpack_require__(513);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__version__ = __webpack_require__(517);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__form_providers__ = __webpack_require__(515);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__normalize_validator__ = __webpack_require__(514);
...
var core_1 = __webpack_require__(1);
var router_1 = __webpack_require__(77);
var service_searchResults_1 = __webpack_require__(286);
var service_todoList_1 = __webpack_require__(141);
...
var CalendarComponent = (function () {
    function CalendarComponent(todolistProvider, router) {
        this.todolistProvider = todolistProvider;
        this.router = router;
    ...
    CalendarComponent.prototype.ngOnInit = function () {
        ...
        this.todolistProvider.todolistHash$.subscribe(function (hashList) {
            ...
            _this.updateDate(_this.today);
            console.log(_this.todoList);
        });
    };
    CalendarComponent.prototype.showBox = function (timestamp) {
        this.ifShowBox = true;
        if (timestamp) {
    ...
    CalendarComponent.prototype.generateCalendar = function () {
        ...
        if (firstDayIsWhatDate == 0) {
            firstDayIsWhatDate = 7;
        }
        ...
        for (row = 0; row < 6; row++) {
            for (cell = 0; cell < 7; cell++) {
                // logic part start
                if ((7 * row + cell + 1 < firstDayIsWhatDate) ||
                    ...
                    var actualDate = row * 7 + cell + 2 - (firstDayIsWhatDate);
                    var obj = { urgent: false, normal: false, date: 7 * row + cell + 2 - firstDayIsWhatDate + '', active: false, branch: 2, timestamp: new Date(this.year, this.month, actualDate).getTime() };
                    ...
                    if (this.todoList[this.year] &&
                        ...
                        if (this.todoList[this.year + ''][this.month + ''][actualDate + ''].urgent.length > 0) {
                            obj.urgent = true;
                        }
                        if (this.todoList[this.year + ''][this.month + ''][actualDate + ''].normal.length > 0) {
                            obj.normal = true;
                        }
    ...
    CalendarComponent.prototype.gotoDetail = function (day) {
        if (day.branch == 1) {
        }
    ...
    CalendarComponent.prototype.focusOnThisCell = function (r, c) {
...
var ResultsListComponent = (function () {
    function ResultsListComponent(searchResults, router) {
    ...
    ResultsListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.searchResults.resultsList$.subscribe(function (item) {
            _this.memoList = item;
        });
    };
    ResultsListComponent.prototype.gotoMemoDetail = function (timestamp) {
...
var SearchComponent = (function () {
    function SearchComponent(router, location, searchResults, todoListProvider) {
        this.router = router;
    ...
    SearchComponent.prototype.ngOnInit = function () {
        ...
        this.todoListProvider.todolistArray$.subscribe(function (list) {
            _this.todothings = list;
        });
    };
    SearchComponent.prototype.findMemo = function (event) {
        var _this = this;
        this.filteredTodoThings = [];
        var keywordRegex = new RegExp('(' + this.keyword + ')');
        this.todothings.forEach(function (todoitem) {
            // 遍历 urgent
            todoitem.urgent.forEach(function (urgentItem) {
                if (urgentItem.memo.includes(_this.keyword)) {
                    _this.filteredTodoThings.push({
                        id: todoitem.id,
            ...
            // 遍历 normal
            todoitem.normal.forEach(function (normalItem) {
                if (normalItem.memo.includes(_this.keyword)) {
                    _this.filteredTodoThings.push({
                        id: todoitem.id,
    ...
    SearchComponent.prototype.focusOnSearch = function () {
        this.router.navigate(['/results']);
    };
    SearchComponent.prototype.backToHome = function () {
        this.keyword = '';
...
var TodolistComponent = (function () {
    function TodolistComponent(todolistProvider, router) {
        this.todolistProvider = todolistProvider;
        this.router = router;
        this.ifShowBox = false;
    ...
    TodolistComponent.prototype.ngOnChange = function () {
        if (this.memo == undefined) {
            this.router.navigate(['calendar']);
        }
    };
    TodolistComponent.prototype.showBox = function () {
        this.ifShowBox = true;
        this.memoTime = this.currentDate.getTime();
    };
    TodolistComponent.prototype.allDone = function () {
        this.memo.urgent.forEach(function (m) {
            m.status = true;
        });
        this.memo.normal.forEach(function (m) {
            m.status = true;
        });
    };
    TodolistComponent.prototype.deleteAllMemo = function () {
    ...
    TodolistComponent.prototype.closeBox = function (ifShowBox) {
        this.ifShowBox = ifShowBox;
    };
    TodolistComponent.prototype.togglePriority = function (index, isUrgent, content) {
        if (isUrgent) {
    ...
    TodolistComponent.prototype.deleteUrgentItem = function (index) {
        if (confirm('Are you certain about this?\nYou will not find it back')) {
            this.memo.urgent.splice(index, 1);
        }
    };
    TodolistComponent.prototype.deleteNormalItem = function (index) {
        if (confirm('Are you certain about this?\nYou will not find it back')) {
            this.memo.normal.splice(index, 1);
        }
    };
    TodolistComponent.prototype.returnToCalendar = function () {
        this.router.navigate(['calendar']);
    };
